...
First, they decided to model the state of a quantum system at time
as a function , and they decided to model the evolution of
$\psi(p)$ for time  as an operator $U(t)$ acting on $\psi(p)$s.
